broker_url = 'amqp://fabian:fabian@rabbit:5672/'
broker_pool_limit = None # Will decrease connection usage
broker_heartbeat = None # We're using TCP keep-alive instead
broker_connection_timeout = 30 # May require a long timeout due to Linux DNS timeouts etc
result_backend = 'db+sqlite:///results.db' # AMQP is not recommended as result backend as it creates thousands of queues
